"""
Валидация входных данных для модели flux-2/flex-image-to-image
"""

def validate_flux_2_flex_image_to_image_input(data: dict) -> tuple[bool, list[str], list[str]]:
    """
    Валидирует входные данные для модели flux-2/flex-image-to-image
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Валидация входных данных для flux-2/flex-image-to-image")
    print("=" * 60)
    print()
    ...
    is_valid, errors, warnings = validate_flux_2_flex_image_to_image_input(test_data)
    ...
    if is_valid:
        ...
        print()
        print("  - Таблица цен:")
        print("    * 1K: 14 кредитов (выше, чем Pro версия: 5 кредитов)")
        print("    * 2K: 24 кредита (выше, чем Pro версия: 7 кредитов)")
        print("  - ВНИМАНИЕ: Flex версия дороже Pro версии, но имеет расширенные возможности")
    else:
