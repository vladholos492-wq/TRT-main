"""
Валидация входных данных для модели kling/v2-1-master-image-to-video
"""

def validate_kling_v2_1_master_image_to_video_input(data: dict) -> tuple[bool, list[str]]:
    """
    Валидирует входные данные для модели kling/v2-1-master-image-to-video
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Валидация входных данных для kling/v2-1-master-image-to-video")
    print("=" * 60)
    print()
    ...
    is_valid, errors = validate_kling_v2_1_master_image_to_video_input(test_data)
